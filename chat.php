...
if (isset($_GET['user'])) {
    ...
    $selectedUser    = mysqli_real_escape_string($con, $selectedUser);
...
<div class="container">
    ...
    <div class="account-info">
        ...
        <div class="user-list">
            <h3 style="font-size: 18px; font-weight: 100; color:green;">Active users</h3>
            <ul>
                <?php 
    ...
    <div class="chat-box" id="chat-box">
        <div class="chat-box-header">
            <h2><?php echo ucfirst($selectedUser); ?></h2><br>
